...
[#if productCategory??]
	[@seo type = "goodsList"]
		<title>[#if productCategory.seoTitle??]${productCategory.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if showPowered] - Powered By xiaohe[/#if]</title>
	...
	[/@seo]
[#else]
	<title>${message("shop.goods.title")}[#if showPowered] - Powered By xiaohe[/#if]</title>
	<meta name="author" content="xiaohe Team" />
	<meta name="copyright" content="xiaohe" />
[/#if]
