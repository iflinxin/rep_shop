...
<title>${message("admin.index.title")} - Powered By xiaohe</title>
...
<body>
	...
	<table class="input">
		<tr>
			...
			<td>
				${systemName}
				<a href="http://3936242.01p.com/" class="silver" target="_blank">[${message("admin.index.license")}]</a>
			</td>
			<th>
		...
		<tr>
			...
			<td>
				<a href="http://3936242.01p.com/" target="_blank">http://3936242.01p.com/</a>
			</td>
			<th>
