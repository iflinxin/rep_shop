...
<title>${message("admin.main.title")} - Powered By xiaohe</title>
...
<body>
	...
	<table class="main">
		<tr>
			<th class="logo">
				<a href="main.jhtml">
					<img src="${base}/resources/admin/images/header_logo.gif" alt="xiaohe" />
				</a>
			</th>
			<th>
				...
				<div class="link">
					<a href="http://3936242.01p.com/" target="_blank">${message("admin.main.official")}</a>|
					<a href="http://3936242.01p.com" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="http://3936242.01p.com//about.html" target="_blank">${message("admin.main.about")}</a>
				</div>
				<div class="link">
