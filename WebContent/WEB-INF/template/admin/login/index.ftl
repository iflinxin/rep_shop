...
<title>${message("admin.login.title")} - Powered By xiaohe</title>
	...
	<div class="login">
		<form id="loginForm" action="login.jhtml" method="post">
			...
			<table>
				<tr>
					<td width="190" rowspan="2" align="center" valign="bottom">
						<img src="${base}/resources/admin/images/login_logo.gif" alt="xiaohe" />
					</td>
					<th>
			...
			<div class="link">
				...
				<a href="http://3936242.01p.com/">${message("admin.login.official")}</a> |
				<a href="http://3936242.01p.com">${message("admin.login.bbs")}</a> |
				<a href="http://3936242.01p.com//about.html">${message("admin.login.about")}</a> |
				<a href="http://3936242.01p.com//contact.html">${message("admin.login.contact")}</a> |
				<a href="http://3936242.01p.com/license.html">${message("admin.login.license")}</a>
			</div>
		</form>
	</div>
</body>
