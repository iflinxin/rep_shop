...
<title>${message("admin.plugin.alipayDualPayment.setting")} - Powered By xiaohe</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/shopxx/" target="_blank">[${message("admin.plugin.alipayDualPayment.register")}]</a>
