...
<title>${message("admin.plugin.alipayDirectPayment.setting")} - Powered By xiaohe</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/shopxx/" target="_blank">[${message("admin.plugin.alipayDirectPayment.register")}]</a>
